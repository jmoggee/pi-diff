...
declare function diffOpenUri(cwd: string, filePath: string, line: number, workspace?: string): string;
declare function formatToolHeaderPath(theme: Pick<PiTheme, "fg">, filePath: string, cwd?: string, line?: number, workspace?: string): string;
declare function diffOpenLine(diff: ParsedDiff): number | undefined;
